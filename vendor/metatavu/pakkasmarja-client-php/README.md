...
*ChatThreadsApi* | [**listChatThreads**](docs/Api/ChatThreadsApi.md#listchatthreads) | **GET** /chatThreads | Returns list of chat threads
...
*ItemGroupsApi* | [**deleteItemGroupPrice**](docs/Api/ItemGroupsApi.md#deleteitemgroupprice) | **DELETE** /itemGroups/{itemGroupId}/prices/{priceId} | Delete item group price
