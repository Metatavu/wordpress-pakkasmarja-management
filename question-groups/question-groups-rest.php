<?php
  ...
  if (!class_exists( 'Metatavu\Pakkasmarja\QuestionGroups\QuestionGroupsRest' ) ) {
    
    class QuestionGroupsRest {
      
      public function __construct() {
        register_rest_field( 'question-group', 'user-group-setings', [
